...
public class CommentController {
    ...
    public String createComment(@Valid @ModelAttribute Comment comment, BindingResult result, Model model) {
        if (result.hasErrors()) {
